...
![](https://s3-us-west-2.amazonaws.com/the-grid-img/p/806ed85e6ead04c667f1add6068814b6d8e609da.jpg)

H Μαριαλένα Νικολοβγένη γεννήθηκε στην Αθήνα και είναι απόφοιτη της Ελληνικής Φιλολογίας του Εθνικού και Καποδιστριακού Πανεπιστημίου Αθηνών.   
Από μικρή, είχε μια έμφυτη τάση να θέλει να βοηθάει ανθρώπους να γίνονται ευτυχισμένοι κάνοντας πραγματικότητα τα όνειρα τους.   
Έτσι, μετά το Πανεπιστήμιο, συνέχισε κι ολοκλήρωσε σπουδές στην Συμβουλευτική ψυχολογία και θεραπεία, στην Εναλλακτική ψυχοθεραπεία και στο LifeCoaching. Παράλληλα ολοκλήρωσε σπουδές στην συγγραφή και στη σεναριογραφία. 

Εκτός από τις σπουδές ασχολήθηκε με το ραδιόφωνο έχοντας για δυο χρόνια την επιμέλεια και την παρουσίαση δικής της εκπομπής. 

Επαγγελματικά δραστηριοποιείται ως συμβουλευτική ψυχοθεραπεύτρια, είτε κάνοντας προσωπικές συνεδρίες είτε ομαδικά σεμινάρια αυτοβελτίωσης και υλοποίησης επιθυμιών. 

Το 2016 έγινε η χρονιά έναρξης της «Ακαδημίας Θαυμάτων» της οποίας είναι η δημιουργός. Στόχος της Ακαδημίας είναι η μετάδοση όλων αυτών των γνώσεων και των πρακτικών, ώστε να μπορέσουμε να γίνουμε οι ίδιοι θαυματοποιοί μέσα στην καθημερινότητα μας. 

« Θαύματα συμβαίνουν καθημερινά, αρκεί να εκπαιδευτείς ώστε να τα αναγνωρίζεις» Εναλλακτική Ψυχοθεραπεύτρια- LifeCoach